...
using BMS.Shop.Products.IServices.Products;
using System;
...
namespace BMS.Shop.Products
{
        ...
        CreateUpdateProductDto>, IProductsAppService
    {
        ...
        public override async Task<ProductDto> UpdateAsync(Guid id, CreateUpdateProductDto input)
        {
            ...
            if (product == null)
                throw new BusinessException(ShopDomainErrorCodes.ProductIsNotExists);
        ...
        public async Task<ProductAttributeValueDto> AddProductAttributeAsync(AddUpdateProductAttributeDto input)
        {
            ...
            if (attribute == null)
                throw new BusinessException(ShopDomainErrorCodes.ProductAttributeIdIsNotExists);
            ...
            switch (attribute.DataType)
            {
                case AttributeType.Date:
                    ...
                    {
                        throw new BusinessException(ShopDomainErrorCodes.ProductAttributeValueIsNotValid);
                    }
