...
using BMS.Shop.Manufacturers.IService;
using BMS.Shop.Permissions;
...
namespace BMS.Shop.Manufacturers
{
        ...
        CreateUpdateManufacturerDto>, IManufacturersAppService
    {
        public ManufacturersAppService(IRepository<Manufacturer, Guid> repository)
            : base(repository)
        {
            //GetPolicyName = ShopPermissions.Manufacturer.Default;
            //GetListPolicyName = ShopPermissions.Manufacturer.Default;
            //CreatePolicyName = ShopPermissions.Manufacturer.Create;
            //UpdatePolicyName = ShopPermissions.Manufacturer.Update;
            //DeletePolicyName = ShopPermissions.Manufacturer.Delete;
        }

        //[Authorize(ShopPermissions.Manufacturer.Delete)]
